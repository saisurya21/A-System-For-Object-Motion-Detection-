...
window = tk.Tk()
window.title("A System for Object Motion Detection")
...
label_title = tk.Label(frame1, text="A System for Object Motion Detection")
...
btn4['font'] = btn_font
btn4.grid(row=3, pady=(20,10), column=3, padx=(20,5))
